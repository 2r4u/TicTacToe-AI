...
def make_computer_move(turn):
  ...
  for i in range(9):
    ...
    if boardcopy[i]==' ':
      ...
      if is_winner(boardcopy):
        b[i]=turn
        print("AI blocked a winning move!")
        draw_board(b)
        return is_winner(b)
# a simple strategy is to always take a corner if they take the center and visaversa
...
# default is just take first available square
